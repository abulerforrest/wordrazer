  ...
  render(): React.ReactNode {
    ...
    return (
      <div className={classes.root}>
        <div className={classes.hiscoreLabel}>Hiscore</div>
        ...
        <div className={classes.playersList}>
          <div className={classes.column}>1</div>
          <div className={classes.column}>20</div>
          <div className={classes.column}>Alex</div>
        </div>
      </div>
    );
  }
