...
class TitlePage extends React.Component<TitlePageProps> {
  ...
  render(): React.ReactNode {
    const { theme, wordOne, wordTwo, classes, buttonLabel } = this.props;

    return (
      <div className={classes.root}>
        <Logo wordOne={wordOne} wordTwo={wordTwo} />
        ...
        <Link href="/init">
          <Button onClick={() => console.log('play')} title={buttonLabel} uppercase bold />
        </Link>
